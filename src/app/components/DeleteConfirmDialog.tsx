        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px] bg-gradient-to-br from-indigo-950/95 to-purple-950/95 text-white border border-indigo-300/20 shadow-2xl rounded-xl backdrop-blur-md">
                <DialogHeader className="flex flex-col items-center gap-3">
                    ...
                    <DialogTitle className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-300 to-red-100">Soruyu Sil</DialogTitle>
                </DialogHeader>

                <div className="text-center text-indigo-100/90 py-5 space-y-4">
                    <p className="text-lg">
                        <span className="font-bold bg-gradient-to-r from-red-200 to-red-100 bg-clip-text text-transparent">{questionTitle}</span> sorusunu silmek istediğinizden emin misiniz?
                    </p>
